...
class FactorGraph:
    ...
    def rm_keyframe(self, ix):
        ...
        with self.video.get_lock():
            # print('self.video.timestamp[ix]', self.video.timestamp[ix])
            # print('self.rm_timestamp', self.video.rm_timestamp)

            # self.video.rm_timestamp = torch.cat((self.video.rm_timestamp, torch.tensor([self.video.timestamp[ix]],
            #                                                                            device=self.video.rm_timestamp.device)))

            # print('remove!')
            # # self.video.rm_timestamp[self.video.rm_current_length.value] = self.video.timestamp[ix]
            # # print(self.video.rm_timestamp)
            # # self.video.rm_current_length.value += 1
            #
            # print('ix',ix)
            # print('self.video.map_counter.value',self.video.map_counter.value, 'self.video.counter.value', self.video.counter.value)
            # print('self.video.counter.value', self.video.counter.value)
            # print('self.video.map_counter.value', self.video.map_counter.value)
            # print('self.video.timestamp', self.video.timestamp)
            # if self.video.map_counter.value >= self.video.counter.value-1:
            self.video.keyframe.del_keyframe(ix)
            # self.video.keyframe.rays[ix] = self.video.keyframe.rays[ix+1]
            # self.video.keyframe.frame_ids = self.video.keyframe.frame_ids[:ix]
