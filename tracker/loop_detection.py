...
class Loop_detector:
    ...
    def find_minimum_flow(self, dataset1, dataset2):
        min_flow = float('inf')
        min_indices = None
...
#################3keyframe
    ...
    timestamps1 = [timestamp + timestamps1_t0 for timestamp in timestamps1]
    ...
    timestamps2 = [timestamp + timestamps2_t0 for timestamp in timestamps2]
...
################################cal
    ...
    min_flow_indices = loop_detector.find_minimum_flow(dataset3, dataset4)
    min_timestamp_indices = (timestamps3[min_flow_indices[0]], timestamps4[min_flow_indices[1]])
