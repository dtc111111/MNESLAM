...
class JointEncoding(nn.Module):
    ...
    def forward(self, rays_o, rays_d, target_rgb, target_d, loop=False, global_step=0):
        ...
        if 'rgb0' in rend_dict:
            rgb_loss += compute_loss(rend_dict["rgb0"], target_rgb)
        ...
        co_fs_loss, co_sdf_loss = get_sdf_loss(z_vals, target_d, sdf, truncation, 'l2', grad=None)
        ...
        ret = {
            ...
            "co_sdf_loss": co_sdf_loss,
            "co_fs_loss": co_fs_loss,
            "e_fs_loss":e_fs_loss,
